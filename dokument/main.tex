...
Niekedy môžeme mať dve rôzne definície tried, ktoré však predstavujú tú istú triedu. Takéto triedy sa volajú ekvivaletné a~vieme ich definovať nasledovne:
\begin{verbatim}
...
Vlastnosti je matkou a~je otcom spája jedna spoločná vlastnosť je rodičom, kde tieto vlastnosti môžeme definovať hierarchicky.
\vbox{\begin{verbatim}
