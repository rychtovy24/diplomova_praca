...
V nasledujúcich kapitolách si povieme niečo o zaužívaných štandardoch, základnom modely, z ktorého vychádzame a podľa, ktorého posudzujeme, či je daná ontológia dobrá. Taktiež rozoberieme existujúce riešenia v doméne kyber bezpečnosti.
...
Aj keď toto riešenie vyzerá byť veľmi schopné, vývoj tejto ontológie už nepokračuje a vôbec už sa nevyužíva. Posledný záznam o úprave bol v roku 2018.
\section{Integrated Cyber Analysis System}
Integrated Cyber Analysis System alebo ICAS je ontológia vytvorená pre TAPIO (Targeted Attack Premonition using Integrated Operational data) nástroj, ktorý je schopný extrahovať dáta z počítačov v jednej sieti do jedného sémantického grafu a tým zjednodušil a urýchlil prácu bezpečnostným tímom pri vyhľadávaní ohrození systému, čím by zvýšila prehľadnosť dát a tiež znížila dopady útoku. 
