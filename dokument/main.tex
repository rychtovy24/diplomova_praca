...
V dnešnej počítačovej dobe sa stále viac a viac vyskytujú kybernetické útoky na firmy, organizácie, štáty alebo aj konkrétne osoby. Tieto útoky veľmi často ani nemusia pochádzať od skúsených útočníkov. Vďaka rôznym fóram a video návodom, môže byť útočník takmer ktokoľvek. Firmy a štátne inštitúcie sa týmto útokom snažia zabraňovať pomocou počítačovej bezpečnosti.
...
co nasa praca ponuka, co prinesie


strucny popis casti a sekcii v praci
...
\minor{MH: $\uparrow$ SNOMED a Google spominas dobre, a v druhom pripade si nespomenul ziadnu ontologiu a pritom ju dobre pozname (Schema.org)\\
MR: spomenute}
...
nema byt\\
MR: okej upravil som\\
MH (26.4.): Asi stale nerozumiem ako ta posledna cast o datach a SPARQL suvisi s touto sekciou... Proste nejak zrazu prepnes na data a SPARQL od konlretnych ontologii, ktore si vmenuval, chyba premostenie\\
MR: jop, uz chapem, odstranil som tu cast}
...
V tejto práci sme vykonali analýzu rôznych existujúcich ontologických riešení v oblasti publikovania spravodajských dát o bezpečnostných hrozbách. Nakoniec sme sa zamerali na ontologické riešenie UCO, ktoré sme najprv vyhodnotili bzhľadom na CTI model. Následne sme zhodnotili, aké časti nie sú dostatočne zapracované v tejto ontológii a túto časť sme rozšírili o ontológiu, ako aj o dáta z verejných databázových riešení OVAL a CVE, ktoré popisujú zraniteľnosti operačných systémov, ich platforiem a produktov.
...
na naco su potrebne)...\\
MR: popisane lepsie, dopisal som UCO}
...
MR: pridany podrobnejsi popis, zakomponovanie pripadov pouzitia}
...
MR: zmenena prva cast k buducemu pokracovaniu}
